...
class NC{
	constructor(app){
		...
		this.finder.OpenProject(this.path);
		this.apt.OpenProject(this.path);
	}
}

module.exports.getNC = function getNC(globalApp){
	return new NC(globalApp);
}
...
module.exports.getMachineState = function getMachineState(globalApp, ncId) {
